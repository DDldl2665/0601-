...
public class Game2Controller implements Initializable {
    ...
    public void Guess()
    {
        if(Controller3.thePlayerBeSelect == 0)
        {
            ...
            myTextField.setText("");
            Controller3.thePlayerBeSelect = 1;
        ...
        else if(Controller3.thePlayerBeSelect == 1)
        {
            ...
            myTextField.setText("");
            Controller3.thePlayerBeSelect = 0;
    ...
    {
        if(Controller3.thePlayerBeSelect == 0){turnLabel.setText("Player 1 turn!");}
        else if(Controller3.thePlayerBeSelect == 1){turnLabel.setText("Player 2 turn!");}
